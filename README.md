...
- `/音樂`：YouTube／Bilibili 點播、插播、暫停、跳過、召喚、序列管理及重啟快照恢復
...
- 點播接受 YouTube、Bilibili 公開影片連結及 `b23.tv` 官方短網址；純文字仍使用 YouTube 搜尋。Bilibili 不使用登入 cookie，需登入、地區限制、直播、番劇、收藏夾、合集及互動影片分支不支援。
